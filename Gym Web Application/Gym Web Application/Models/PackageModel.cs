...
public class PackageModel
{
    ...
    [Range(1, int.MaxValue, ErrorMessage = "Number of months must be a positive number")]
    ...
    [Required(ErrorMessage = "Freeze limit is required")]
    [Range(0, int.MaxValue, ErrorMessage = "Freeze limit must be a non-negative number")]
